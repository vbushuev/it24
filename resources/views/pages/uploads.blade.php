...
<div class="container">
    ...
    <div class="panel panel-default">
                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="javascript:{page.filters.data.f=0;page.filters.data.supply_id='';page.load();}">Очистить</a></li>
        ...
        <div id="js-container" class="panel-body" data-ref="/data/uploads">
        </div>
    </div>
    <!--<div class="row">
