...
type:"GET",data:page.filters.data,dataType:"json",beforeSend:function(){page.loading=!0;page.filters.data.f||a.html("")},success:function(b){var c=a.attr("data-func");console.debug(typeof window[c]+" "+typeof _contentLoader);if("function"==typeof window[c])window[c](b);else"undefined"!=typeof _contentLoader&&_contentLoader(b)},complete:function(){page.loading=!1;$(document).trigger("page:loaded")}})})},submit:function(){if(arguments.length){var a=arguments[0],b={};$(a.form+" input:not(.no-request)").each(function(){var a=
